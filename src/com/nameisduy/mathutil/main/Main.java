 ...
 */
package com.nameisduy.mathutil.main;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //TEST CASE #4: input n = -5; hy vọng bị chửi!!! n must between 0..20
        System.out.println("See the Illegal Argument Exception at n = -5:");
        MathUtil.getFactorial(-5);
        
        //VIỆC KẾT LUẬN HÀM ĐÚNG HAY SAI THÌ MẮT TA PHẢI DUYỆT QUA TỪNG CẶP EXPECTED == ACTUAL HAY KHÔNG??
        //VÀ DUYỆT HẾT MỚI DÁM KẾT LUẬN
        //HƠI MẤT SỨC, DỄ SAI SÓT NẾU CÓ NHIỀU CASE TEST KHÁC NHAU
        //NẾU MÁY LÀM DÙM LUÔN PHẦN MẤT SỨC NÀY -> TEST AUTOMATION
        //MÁY QUÉT QUA HẾT CÁC CẶP EXPECTED VÀ ACTUAL VÀ CHỐT DEAL 1 CÂU: ĐÚNG, SAI!!
        //NHỜ TRÒ NÀY -> TỰ ĐỘNG HÓA ĐƯỢC VIỆC KIỂM SOÁT CHẤT LƯỢNG CODE
